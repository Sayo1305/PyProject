      This is my final project for CODE IN PLACE 2021 .it is a Quiz program where one by one 10 question with 4 Option are given and you have to answer correctly. As it is a 
